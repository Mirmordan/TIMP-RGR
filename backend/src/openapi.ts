      ...
      Stream: {
        ...
        properties: {
          ...
          parentType: {
            type: 'string',
            nullable: true,
            description: 'Тип родительского объекта (device), null — если родителя нет.',
          },
          createdAt: { type: 'string', format: 'date-time' },
        },
      },
      ...
      Process: {
        ...
        properties: {
          ...
          parentType: {
            type: 'string',
            nullable: true,
            description: 'Тип родительского объекта (stream), null — если родителя нет.',
          },
          createdAt: { type: 'string', format: 'date-time' },
        },
      },
      Chunk: {
        ...
        properties: {
          ...
          parentType: {
            type: 'string',
            nullable: true,
            description: 'Тип родительского объекта (process), null — если родителя нет.',
          },
          createdAt: { type: 'string', format: 'date-time' },
        },
      },
      ...
      Incident: {
        ...
        properties: {
          ...
          parentObjectId: {
            type: 'string',
            nullable: true,
            description: 'ID родительского объекта (процесса) в иерархии objects.',
          },
          parentType: {
            type: 'string',
            nullable: true,
      ...
      RbacObject: {
        ...
        properties: {
          ...
          parentType: {
            type: 'string',
            nullable: true,
            description: 'Тип родительского объекта (device/stream/process), null для корня.',
          },
          createdAt: { type: 'string', format: 'date-time' },
        },
      },
